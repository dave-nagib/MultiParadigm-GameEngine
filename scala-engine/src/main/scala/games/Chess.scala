...
import AbstractGameEngine.GameState
...
object Chess {
  ...
  def generalChecks(black: Boolean, gameState: GameState, move: ((Int, Int),(Int, Int))): Boolean = {
    ...
    if(black ^ (gameState._2 % 2 == 0)) {
      return false
    } else if (toPiece == whiteSquare || toPiece == blackSquare)
      return true
  ...
  def bishop(black: Boolean)(gameState: GameState, move: ((Int, Int), (Int, Int))): Boolean = {
    ...
    for(i <- 1 until math.abs(to._1 - from._1))
      if(gameState._1(from._1 + i * rowCoef)(from._2 + i * colCoef) != whiteSquare && gameState._1(from._1)(from._2) != blackSquare)
        return false
  ...
  def chessController(gameState: GameState, move: String): (GameState, Boolean) = {
    ...
    newState(from._1)(from._2) = if((from._1 + from._2) % 2 == 0) whiteSquare else blackSquare
